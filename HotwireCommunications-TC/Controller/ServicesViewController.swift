...
class ServicesViewController: BaseViewController {
  let headerTitle = "MY_PHONE_SERVICE"
  
  let listArray = ["Phone_Portal","Settings","Upgrade_Phone_Service","Accession_Voip_Phone"]
  ...
  override func viewWillAppear(_ animated: Bool) {
    ...
    self.title = "Services".localized(lang: languageCode, comment: "")
  }
